...
function renderEducation() {
  ...
  el('eduSummary').innerHTML = `
    <div class="edu-item"><span>평균 교육이수율</span><strong>${avg}${avg === '-' ? '' : '%'}</strong></div>
    <div class="edu-item"><span>교육 참여자 수 합계</span><strong>${n(totalParticipants)}명</strong></div>
    <div class="edu-item"><span>연간 교육시간 평균</span><strong>${avgHours}시간</strong></div>
  `;
}
